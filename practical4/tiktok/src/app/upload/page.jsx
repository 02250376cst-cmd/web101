          ...
          <div onClick={() => videoInputRef.current?.click()}
            ...
            {videoPreview
              ...
              : <>
                  ...
                  <p className="text-sm font-medium text-gray-600 text-center px-4">Click to select video</p>
          ...
          <div className="flex-1 space-y-4">
            <div>
              ...
              <input value={title} onChange={(e) => setTitle(e.target.value)}
                placeholder="Add a title for your video" maxLength={100}
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:border-gray-500 text-sm" required />
              <p className="text-xs text-gray-400 mt-1 text-right">{title.length}/100</p>
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1.5">Description</label>
              <textarea value={description} onChange={(e) => setDescription(e.target.value)}
                placeholder="Describe your video..." rows={4} maxLength={500}
