    ...
    <div className="flex flex-col items-center justify-center py-8 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-4">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-red-500 text-white py-3 rounded-md font-medium hover:bg-red-600 transition"
              disabled={isLoading}
            >
        ...
        <div className="text-center mt-4">
            <p className="text-gray-500">Don't have an account? <Link href="/signup" className="text-red-500 hover:underline">Sign up</Link></p>
        </div>
      </div>
    </div>
  );
